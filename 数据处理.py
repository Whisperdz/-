...
plt.tight_layout()
multi_feature_img = plot_to_base64()
plt.close()
...
plt.ylabel("特征", fontproperties=font_prop)
plt.tight_layout()
binary_feature_img = plot_to_base64()
plt.close()
...
plt.legend(title='聚类类别', prop=font_prop)
plt.tight_layout()
cluster_scatter_img = plot_to_base64()
plt.close()
...
plt.tight_layout()
severity_pie_img = plot_to_base64()
plt.close()
...
plt.tight_layout()
cluster_bar_img = plot_to_base64()
plt.close()
...
<body>
    ...
    <div class="section">
        ...
        <div class="image-container">
            <img src="data:image/png;base64,{{ severity_pie_img }}" alt="事故严重程度分布">
            <p class="image-caption">图1: 事故严重程度分布情况</p>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="image-container">
            <img src="data:image/png;base64,{{ multi_feature_img }}" alt="多分类模型特征重要性">
    ...
    <div class="section">
        ...
        <div class="image-container">
            <img src="data:image/png;base64,{{ binary_feature_img }}" alt="二分类模型特征重要性">
    ...
    <div class="section">
        ...
        <div class="image-container">
            <img src="data:image/png;base64,{{ cluster_bar_img }}" alt="聚类分布">
            <p class="image-caption">图4: 聚类分布情况</p>
        </div>

        <div class="image-container">
            <img src="data:image/png;base64,{{ cluster_scatter_img }}" alt="聚类散点图">
...
# 保存HTML文件
with open("traffic.html", "w", encoding="utf-8") as f:
    f.write(html_content)

print("\nHTML报告已生成: traffic.html")
